...
import SimpleCard2 from "./ourLestDBJS/ourLestProps";
import array2 from "./ourLestDBJS/ourLestDB";
  ...
  render() {
    ...
    return (
      <div>
        ...
        <p className="ourLatestArticleSmallText">Nullam dictum felis eu pede mollis pretium. Integer tincidunt. Cras dapibus.</p>        <Slider {...settings}>
        {
                    array2.map((item) => {
                        return(
                            <div>
